        ...
        <div class="card_container">
            <div class="front">
                <div class="image">
                    ...
                    <img src="../IMAGES/image_payment/mtn1.png" alt="">
                </div>
        ...
        ?>
            ...
            switch ($contact) {
                case $contact >= 650000000 && $contact <= 654999999:
                    ...
                    $trans_otp = rand(1000000,9999999);
                    $genInfo2 = mysqli_query($link, "select * from bank_account where contact = '$_SESSION[contact]'");
                    while($genRow2 = mysqli_fetch_array($genInfo2)){
                        $bid = $genRow2["id"];
                    }

                    mysqli_query($link, "insert into transaction_otp(id,otp_number,contact,bank_account_id,address) values(NULL,'$trans_otp','$contact','$bid','$email')");
            ?>
                    <script>
